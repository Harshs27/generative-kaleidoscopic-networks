...
- `CELEB-A Kaleidoscope`: We randomly chose 1K celebrity images from CELEB-A dataset and did manifold learning with MLP $L=10, H=2000$. The output manifold is not smooth, so we can see many 'jumpy' transitions. Currently investigating a fix for this issue. The model used can be downloaded from [model-celeba-kaleiscope](<https://drive.google.com/file/d/1Gvqbell-xOs6foS1Y-q9lXBAjFW6UrMa/view?usp=sharing>).
<p align="center">
